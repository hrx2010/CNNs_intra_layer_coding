function generate_RD_frontier_intra(archname,tranname,testsize,inlayers,outlayer,strides)
...
save(sprintf('%s_%s_sum_%d_%d_%d_%s_intra',archname,tranname,testsize,inlayers(1),inlayers(end),outlayer),...
