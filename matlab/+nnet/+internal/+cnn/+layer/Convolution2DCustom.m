classdef Convolution2DCustom < nnet.internal.cnn.layer.Layer
    ...
    methods
        function this = Convolution2DCustom( ...
                name, filterSize, numChannels, numFilters, stride, ...
            dilationFactor, paddingMode, paddingSize)
    ...
    methods(Access = private)
       ...
       function [Z, memory] = predictNormal( this, X )
        ...
        function Z = doForward(this, X, weights, bias)
            ...
            X = padarray(X,this.PaddingSize(1:2)) - this.ChannelMean;
            Z = this.ExecutionStrategy.forward(X, weights, bias, 0, 0, 0, 0, ... 
