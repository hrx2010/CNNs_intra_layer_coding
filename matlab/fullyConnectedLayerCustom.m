function layer = fullyConnectedLayerCustom( varargin )
...
layer = nnet.cnn.layer.FullyConnectedLayerCustom(internalLayer);
...
inputArguments.ChannelMean = p.Results.ChannelMean;
end
