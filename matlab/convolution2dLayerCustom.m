function layer = convolution2dLayerCustom( varargin )
...
internalLayer = nnet.internal.cnn.layer.Convolution2DCustom(args.Name, ...
                                                      args.FilterSize, ...
                                                      args.NumChannels, ...
                                                      args.NumFilters, ...
                                                      args.Stride, ...
...
% convolutional layer.
layer = nnet.cnn.layer.Convolution2DLayerCustom(internalLayer);
