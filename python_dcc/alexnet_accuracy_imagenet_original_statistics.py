...
from alexnet_statistics import *
...
alexnet_model = alexNet_statistics(x, dropoutPro, classNum, skip)
...
conv_outputs = [alexnet_model.CONV_OUTPUT_1 , alexnet_model.CONV_OUTPUT_2 , alexnet_model.CONV_OUTPUT_3 , alexnet_model.CONV_OUTPUT_4 , alexnet_model.CONV_OUTPUT_5]
...
top_1, top_5 = run_inference_alexnet_statistics(sess, x, scores, conv_inputs, conv_outputs, number_validation_images=num_tesing_images) 
